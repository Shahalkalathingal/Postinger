    ...
    return (
      <React.Fragment>
        {followingsNum && followings || followings !== false ? (
          ...
          //else
         <div >
                <div className="hide-on-med-and-down preloader-wrapper big active" style={{ left: "40rem", top: '8rem' }}>
                ...
                {/** On Meduim */}
                <div className="hide-on-large-only hide-on-small-only  preloader-wrapper big active" style={{ left: "26.3rem", top: '8rem' }}>
                ...
                {/** On Small */}
                <div className="hide-on-med-and-up preloader-wrapper big active" style={{ left: "9.1rem", top: "8rem" }}>
